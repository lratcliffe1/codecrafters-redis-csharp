...
public static class ServiceCollectionExtensions
{
  ...
  private static void AddKeyedCommands(IServiceCollection services)
  {
    ...
    services.AddKeyedSingleton<IRedisCommand, GeoDistCommand>("GEODIST");
    services.AddKeyedSingleton<IRedisCommand, GeoSearchCommand>("GEOSEARCH");
    ...
    services.AddKeyedSingleton<IRedisCommand, UnwatchCommand>("UNWATCH");

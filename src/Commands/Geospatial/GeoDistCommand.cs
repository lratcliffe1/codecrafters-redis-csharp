...
public class GeoDistCommand(ICacheStore cacheStore) : IRedisCommand
{
  ...
  public Task<string> ExecuteAsync(List<RespValue> args, CommandExecutionContext context)
  {
    ...
    double distance = GeoHelper.CalculateDistanceUsingHaversineFormula(latitude1, longitude1, latitude2, longitude2);

    return CommandHelper.FormatBulkAsync(distance.ToString(CultureInfo.InvariantCulture));
  }
}
